...
.. _program_listing_file_G__code_esp_code_freezer_main_wifible_esp_ibeacon_api.h:

Program Listing for File esp_ibeacon_api.h
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_G__code_esp_code_freezer_main_wifible_esp_ibeacon_api.h>` (``G:\code\esp\code\freezer\main\wifible\esp_ibeacon_api.h``)
