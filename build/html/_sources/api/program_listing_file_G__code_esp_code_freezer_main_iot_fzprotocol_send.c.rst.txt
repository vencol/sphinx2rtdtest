...
.. _program_listing_file_G__code_esp_code_freezer_main_iot_fzprotocol_send.c:

Program Listing for File fzprotocol_send.c
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_G__code_esp_code_freezer_main_iot_fzprotocol_send.c>` (``G:\code\esp\code\freezer\main\iot\fzprotocol_send.c``)
