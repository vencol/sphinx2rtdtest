...
.. _program_listing_file_main_freezerdrv_drv_adc.c:

Program Listing for File drv_adc.c
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_main_freezerdrv_drv_adc.c>` (``main\freezerdrv\drv_adc.c``)
